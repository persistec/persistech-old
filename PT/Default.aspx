<%@ Page Title="" Language="VB" MasterPageFile="~/PT/MasterPage.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="PT_Default" %>
...
<h2>Loja Online - Promoções!</h2>
			<ul class="projects four-columns">
				<li data-tag="web_design, typography">
					<div class="projects-thumb">
						<a href="portfolio.aspx?id=1">
							<img src="../images/gallery/loja/01.jpg" alt="" />
				...
				<li data-tag="web_design, typography">
					<div class="projects-thumb">
						<a href="portfolio.aspx?id=1">
							<img src="../images/gallery/loja/02.jpg" alt="" />
							<div class="thumb-cover"><div class="thumb-more"></div></div>
						</a>
						<div class="recent-project-details">
							<h5>Produto 1</h5>
				...
				<li data-tag="web_design, typography">
					<div class="projects-thumb">
						<a href="portfolio.aspx?id=1">
							<img src="../images/gallery/loja/03.jpg" alt="" />
							<div class="thumb-cover"><div class="thumb-more"></div></div>
						</a>
						<div class="recent-project-details">
							<h5>Produto 1</h5>
			...
			<ul class="projects four-columns" style=" padding-top:20px">
                ...
                <li data-tag="web_design, typography">
					<div class="projects-thumb">
						...
						<div class="recent-project-details">
							<h5>Ripro</h5>
							<a href="Newmedia.aspx?m=4&p=1">Web Design</a> / <a href="Newmedia.aspx?m=4&p=1"><%= Resources.LocalizedText.Programacao%></a>
						</div>
    ...
    <div class="fb-like" data-href="http://www.facebook.com/Persistech" data-send="false" data-width="420" data-show-faces="true"></div>
        ...
        <div class="block one-fourth last">
          ...
          <iframe width="200" height="330" src="https://my.sendinblue.com/users/subscribe/js_id/1uet3/id/2" frameborder="0" scrolling="no" allowfullscreen style="margin-top:-10px"></iframe>
           ...
           <asp:LinkButton ID="BT_ENVIAR" runat="server" CssClass="newsletter_button" ><span>ENVIAR</span></asp:LinkButton>
