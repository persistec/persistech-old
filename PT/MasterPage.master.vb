...
Partial Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With menuSTR
            ...
            '.Append("<li " & IIf(Request("m") = "8", active, "") & "><a href=""QuemSomos.aspx?m=1"">" & Resources.LocalizedText.Menu_QuemSomos & "</a></li> ")
            '.Append("<li " & IIf(Request("m") = "2", active, "") & "><a href=""Solucoes.aspx?m=2"">" & Resources.LocalizedText.Menu_Solucoes & " </a></li> ")
            '.Append("<li " & IIf(Request("m") = "3", active, "") & "><a href=""Servicos.aspx?m=3"">" & Resources.LocalizedText.Menu_Servicos & " </a></li> ")
            '.Append("<li " & IIf(Request("m") = "4", active, "") & "><a href=""Newmedia.aspx?m=4"">" & Resources.LocalizedText.Menu_NewMedia & " </a></li> ")
            '.Append("<li " & IIf(Request("m") = "5", active, "") & "><a href=""Clientes.aspx?m=5"">" & Resources.LocalizedText.Menu_Clientes & " </a></li> ")
            '.Append("<li " & IIf(Request("m") = "6", active, "") & "><a href=""Contatos.aspx?m=6"">" & Resources.LocalizedText.Menu_Contactos & " </a></li> ")


            .Append("<li " & IIf(Request("m") = "", active, "") & "><a href=""default.aspx"">" & Resources.LocalizedText.Menu_Inicio & "</a><span>Bem Vindo à Persistec</span></li> ")
