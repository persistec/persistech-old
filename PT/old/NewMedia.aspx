<%@ Page Title="" Language="VB" MasterPageFile="~/PT/MasterPageConteudo.master" AutoEventWireup="false" CodeFile="NewMedia.aspx.vb" Inherits="PT_NewMedia" %>
		...
		<div class="sidebar-left">
			...
			<div class="block">
				<ul class="gallery-filter" >
					...
					<li><a href="#logotipos">Imagem Corporativa</a></li>
					<li><a href="#lojas">Lojas Online</a></li>
