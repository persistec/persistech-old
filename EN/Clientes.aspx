<%@ Page Title="Persistech - Clientes" Description="O sucesso dos nossos clientes é o nosso sucesso! Conheça os nossos principais clientes!" Language="VB" MasterPageFile="~/EN/MasterPageConteudo.master" AutoEventWireup="false" CodeFile="Clientes.aspx.vb" Inherits="EN_Clientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="line-sp"></div>
    ...
    <div class="sidebar-left">
        <div class="block">
            <h1 style="padding-top: 5px; padding-bottom: 20px; color: #d2a628">Customers</h1>
        ...
        <div class="block">
            <ul class="gallery-filter">
                ...
                <li><a href="#vendas">Sales with free delivery</a></li>
                <li><a href="#redes">Voice and Data Networks</a></li>
                <li><a href="#helpdesk">HelpDesk</a></li>
                <li><a href="#servidores">Server Administration</a></li>
                <li><a href="#websites">Websites</a></li>
                <li><a href="#design">Graphic Design</a></li>
                <li><a href="#imagem">Corporate Image</a></li>
                <li><a href="#registos">Domain Registration and Emails</a></li>
